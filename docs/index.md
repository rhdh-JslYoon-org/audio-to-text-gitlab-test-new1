...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test-new1](https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test-new1)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test-new1-gitops](https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test-new1-gitops)

# **Usage**

To access the audio-to-text-gitlab-test-new1 application that was deployed using the Software Template, complete the following instructions:
